...
Public Class ALUMNOSPIDEFACTURA
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SAC.ALUMNOSPIDEFACTURA.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedALUMNOSPIDEFACTURA
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ALUMNOSPIDEFACTURA = New ALUMNOSPIDEFACTURA()
        rpt.Site = Me.Site
        Return rpt
    End Function
