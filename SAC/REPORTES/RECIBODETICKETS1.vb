...
Public Class RECIBODETICKETS1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SAC.RECIBODETICKETS.rpt"
        End Get
        Set(value As String)
            'Do nothing
        End Set
...
Public Class CachedRECIBODETICKETS1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RECIBODETICKETS = New RECIBODETICKETS()
        rpt.Site = Me.Site
        Return rpt
    End Function
