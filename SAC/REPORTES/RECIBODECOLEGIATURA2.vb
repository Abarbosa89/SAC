...
Public Class RECIBODECOLEGIATURA2
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "RECIBODECOLEGIATURA2.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SAC.RECIBODECOLEGIATURA2.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_NOFOLIO() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedRECIBODECOLEGIATURA2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RECIBODECOLEGIATURA2 = New RECIBODECOLEGIATURA2()
        rpt.Site = Me.Site
        Return rpt
    End Function
