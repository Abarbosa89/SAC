...
Public Class RECIBOCOLEGIATURA
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SAC.RECIBOCOLEGIATURA.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRECIBOCOLEGIATURA
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RECIBOCOLEGIATURA = New RECIBOCOLEGIATURA()
        rpt.Site = Me.Site
        Return rpt
    End Function
