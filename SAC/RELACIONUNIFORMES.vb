...
Public Class RELACIONUNIFORMES
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SAC.RELACIONUNIFORMES.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRELACIONUNIFORMES
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RELACIONUNIFORMES = New RELACIONUNIFORMES()
        rpt.Site = Me.Site
        Return rpt
    End Function
